...
// AES ECB模式加密
function encryptByAES(plaintText) {
    //把私钥转换成16进制的字符串
    var keyHex = CryptoJS.enc.Utf8.parse(key);
    //模式为ECB padding为Pkcs7
    var encryptedData = CryptoJS.AES.encrypt(plaintText, keyHex, {
...
// AES ECB模式解密
function decryptByDES(encryptedData) {
    //  上面已经转换了，下面就不需要了
    ...
    var decryptedData = CryptoJS.AES.decrypt(encryptedBase64Str, keyHex, {
        mode: CryptoJS.mode.ECB,
        padding: CryptoJS.pad.Pkcs7
    });
    //以utf-8的形式输出解密过后内容
